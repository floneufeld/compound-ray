...
def configureFunctions(eyeRenderer):
  ...
  eyeRenderer.raycastGeometry.argtypes = [
      c_float, c_float, c_float,
      c_float, c_float, c_float,
      POINTER(c_float3),
      POINTER(c_float3)
  ]
  eyeRenderer.raycastGeometry.restype = c_bool
  eyeRenderer.isKeyPressed.argtypes = [c_int]
  eyeRenderer.isKeyPressed.restype = c_bool
